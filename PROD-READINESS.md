...
**That was written as "every live anchor" and it was five of seven - corrected per REVIEW-R5 R5-2 and R5-6.**
...
The seventh is older and not round 5's: the context section's `validateBackup` anchor was `:136` at the baseline and round 2's `daf054d` moved it to `:169` with nothing re-basing it, which a complete re-grep of the file just edited would have surfaced.
