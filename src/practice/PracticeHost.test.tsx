...
describe('PracticeHost mode picker', () => {
  it('lists exactly the five surviving modes', () => {
    render(
      <PracticeHost
    ...
    expect(screen.queryByText('Combo drill')).not.toBeInTheDocument()
    expect(screen.queryByText('Postflop drill')).not.toBeInTheDocument()
    expect(screen.queryByText('Range vs board')).not.toBeInTheDocument()
  })
